...
namespace DuckGame.R6S
{
    ...
    public class TalonShield : Placeable
    {
        public TalonShield(float xpos, float ypos) : base(xpos, ypos)
        {
    ...
    public class TalonShieldAP : Device
    {
        public TalonShieldAP(float xpos, float ypos) : base(xpos, ypos)
        {
